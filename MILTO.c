/* MILTO.F -- translated by f2c (version 20100827).
...
static real c_b83 = 50.f;
static integer c__300 = 300;
static integer c__25 = 25;

/* Subroutine */ int milto_(char *vic, char *vid, integer *vii, real *vir, 
	...
	vid_len)
{
    ...
    static integer i__, verc, iv1m, ie, cifsig, itemax, mxgrc, mzgrc, mzvrc, 
	    mxvrc;
    static real oatc, wxmin, ener, error, vrxwind, mxwind, mil_prev__;
    extern /* Subroutine */ int lectg_(char *, integer *, ftnlen), lecto_(
	    ...
	    integer *, real *, real *), zfalse_(E_fp, real *, integer *, real 
	    *, real *, real *, integer *, integer *), ebrk_(integer *, real *,
	     real *, real *), tospeed_(real *, real *, real *, real *, real *,
	     integer *, integer *, integer *, integer *, real *, real *, real 
	    *, integer *, integer *, real *, real *, integer *, real *, 
	    integer *, real *, integer *, real *, real *, real *, real *), 
	    fpath_(integer *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *, integer *, real *, real *, real *, integer *
	    , integer *, integer *, integer *, real *, integer *, real *, 
	    integer *, real *, integer *, real *, integer *, real *, integer *
	    , real *, integer *, real *, integer *, real *, integer *, real *,
	     integer *, real *, integer *, real *, integer *, real *, real *, 
	    integer *), escrit_(integer *, real *, integer *, integer *, 
	    integer *, integer *);
    static real vl1, vl2;
    extern doublereal fbrk_(), vrfu_(real *), difobsm_(real *);

/* MS$ATTRIBUTES DLLEXPORT :: MILTO */
/* MS$ATTRIBUTES ALIAS: 'MILTO' :: MILTO */
/*      POINTER(PVIC,VIC) */
/*      POINTER(PVID,VID) */
    ...
    if (s_cmp(afm_1.afm, afm_1.afm_dat__, (ftnlen)6, (ftnlen)6) != 0 || s_cmp(
	    afm_1.afm, afm_1.afm_mil__, (ftnlen)6, (ftnlen)6) != 0 || s_cmp(
	    afm_1.afm, afm_1.afm_taf__, (ftnlen)6, (ftnlen)6) != 0 || (real) 
	    resto_1.mil != mil_prev__) {
	lecto_(vici, ierr, (ftnlen)200);
	if (*ierr > 0) {
	    return 0;
	}
    }
    init_(&c__1, &c__1, dato6_1.nsen, &vii[1], &vir[1], &voi[1], &vor[1], 
	    ierr);
    if (*ierr > 0) {
	return 0;
    }
    verc = 100;
    resto_1.ifc = ini2_1.ifl;
    resto_1.ifr = ini2_1.ifl;
    resto_1.ifa = ini2_1.ifl;
    if (ini2_1.ifl == 2) {
	for (i__ = 1; i__ <= 15; ++i__) {
	    if (dato3_1.pgrc[i__ - 1] == 2) {
		resto_1.ifc = 1;
	    }
	    if (dato4_1.pvrc[i__ - 1] == 2) {
		resto_1.ifr = 1;
	    }
	    if (dato3_1.pgrc[i__ - 1] == 2 || dato4_1.pvrc[i__ - 1] == 2) {
		resto_1.ifa = 1;
	    }
	}
    }
	...
	*ierr = 10;
    ...
    manual3r_(&c__1, &dato5_1.grvmg[ini2_1.ifl - 1], &dato5_1.xtvmg[
	    ...
	    ini2_1.vmcg, &ini1_1.hp, &ie);
    if (ie == 2) {
	goto L10000;
    }
    manual3r_(&c__3, &dato3_1.grgr1[resto_1.ifc - 1], &dato3_1.xdgr1[
	    resto_1.ifc * 500 - 500], &dato3_1.ytgr1[resto_1.ifc * 500 - 500],
	     &dato3_1.zhgr1[resto_1.ifc * 20 - 20], &dato3_1.ngr1[resto_1.ifc 
	    * 20 - 20], &dato3_1.nzgr1[resto_1.ifc - 1], &resto_1.cfl1, &
	    ini2_1.oat2, &ini1_1.hp, &ie);
    if (ie == 2) {
	goto L10000;
    }
    manual3r_(&c__1, &dato4_1.grvr1[resto_1.ifr - 1], &dato4_1.xtvr1[
	    resto_1.ifr * 500 - 500], &dato4_1.ysvr1[resto_1.ifr * 500 - 500],
	     &dato4_1.zhvr1[resto_1.ifr * 20 - 20], &dato4_1.nvr1[resto_1.ifr 
	    * 20 - 20], &dato4_1.nzvr1[resto_1.ifr - 1], &ini2_1.oat2, &
	    resto_1.vre1, &ini1_1.hp, &ie);
    if (ie == 2) {
	goto L10000;
    }
L500:
...
L600:
    ...
    resto_1.vel = 0.f;
    ini2_1.v1[ini2_1.ind * 3 - 3] = vrfu_(&wxmin);
    if (resto_1.ierv == 2) {
	goto L10000;
    }
L610:
    if (resto_1.cflc < ini1_1.rwy - ini1_1.del_rwy__ || iv1m != 0) {
	if (iv1m != 0) {
	    iv1m = 0;
	}
	if (ini2_1.v1[ini2_1.ind * 3 - 3] < ini2_1.vmcg[ini2_1.ind - 1]) {
	    ...
	    corr_(&ie, &c__1, &vl1, &ini2_1.vmcg[ini2_1.ind - 1], ini2_1.x, &
		    dato4_1.pvrc[resto_1.ifr * 15 - 15], &mxvrc, &mzvrc, &
		    dato4_1.grvrc[(resto_1.ifr << 3) - 8], &dato4_1.nzvrc[(
		    resto_1.ifr << 3) - 8], &dato4_1.nvrc[((resto_1.ifr << 3) 
		    + 1) * 30 - 270], &dato4_1.xvrc[((resto_1.ifr << 3) + 1) *
		     400 - 3600], &dato4_1.yvrc[((resto_1.ifr << 3) + 1) * 
		    400 - 3600], &dato4_1.zvrc[((resto_1.ifr << 3) + 1) * 30 
		    - 270]);
	    if (ie == 2) {
		goto L10000;
	    }
	    manual3r_(&c__3, &dato4_1.grvr3[resto_1.ifr - 1], &dato4_1.xsvr3[
		    resto_1.ifr * 200 - 200], &dato4_1.ysvr3[resto_1.ifr * 
		    200 - 200], &dato4_1.zwvr3[resto_1.ifr * 10 - 10], &
		    dato4_1.nvr3[resto_1.ifr * 10 - 10], &dato4_1.nzvr3[
		    resto_1.ifr - 1], &vl2, &vl1, &wxmin, &ie);
	    if (ie == 2) {
		goto L10000;
	    }
	    manual3r_(&c__5, &dato4_1.grvr2[resto_1.ifr - 1], &dato4_1.xsvr2[
		    resto_1.ifr * 500 - 500], &dato4_1.ysvr2[resto_1.ifr * 
		    500 - 500], &dato4_1.zdvr2[resto_1.ifr * 20 - 20], &
		    dato4_1.nvr2[resto_1.ifr * 20 - 20], &dato4_1.nzvr2[
		    resto_1.ifr - 1], &vl2, &resto_1.vre1, &ini2_1.asd[
		    ini2_1.ind * 3 - 3], &ie);
	    if (ie == 2) {
		goto L10000;
	    }
	    if (ini2_1.asd[ini2_1.ind * 3 - 3] > ini1_1.rwy + ini1_1.swy) {
		iv1m = 2;
		goto L800;
	    }
	} else {
	    ini2_1.asd[ini2_1.ind * 3 - 3] = resto_1.cflc;
	    ini2_1.ilim[(ini2_1.ind << 2) - 3] = ini2_1.ilim[(ini2_1.ind << 2)
		     - 4];
	}
	ini2_1.tor[ini2_1.ind * 3 - 3] = resto_1.cflc;
/* L700: */
	vrspeed_(&resto_1.vrot1, &ini2_1.vmcg[ini2_1.ind - 1], &wxmin, &
		ini2_1.vr[ini2_1.ind - 1], &ie, &dato5_1.grvro1[ini2_1.ifl - 
		1], &dato5_1.nzvro1[ini2_1.ifl - 1], &dato5_1.nvro1[
		ini2_1.ifl * 15 - 15], &dato5_1.zwvro1[ini2_1.ifl * 15 - 15], 
		&dato5_1.xsvro1[ini2_1.ifl * 500 - 500], &dato5_1.ysvro1[
		ini2_1.ifl * 500 - 500], &dato5_1.grvro2[ini2_1.ifl - 1], &
		dato5_1.nzvro2[ini2_1.ifl - 1], &dato5_1.nvro2[(ini2_1.ifl << 
		4) - 16], &dato5_1.zwvro2[(ini2_1.ifl << 4) - 16], &
		dato5_1.xsvro2[ini2_1.ifl * 500 - 500], &dato5_1.ysvro2[
		ini2_1.ifl * 500 - 500], &dato5_1.grvro3[ini2_1.ifl - 1], &
		dato5_1.nvro3[ini2_1.ifl - 1], &dato5_1.xwvro3[ini2_1.ifl * 
		50 - 50], &dato5_1.ysvro3[ini2_1.ifl * 50 - 50]);
	if (ie == 2) {
	    goto L10000;
	}
	ini2_1.v1[ini2_1.ind * 3 - 1] = ini2_1.vr[ini2_1.ind - 1];
	ini2_1.tor[ini2_1.ind * 3 - 1] = resto_1.cflc;
	corr_(&ie, &c__1, &vl1, &ini2_1.vr[ini2_1.ind - 1], ini2_1.x, &
		dato4_1.pvrc[resto_1.ifr * 15 - 15], &mxvrc, &mzvrc, &
		dato4_1.grvrc[(resto_1.ifr << 3) - 8], &dato4_1.nzvrc[(
		resto_1.ifr << 3) - 8], &dato4_1.nvrc[((resto_1.ifr << 3) + 1)
		 * 30 - 270], &dato4_1.xvrc[((resto_1.ifr << 3) + 1) * 400 - 
		3600], &dato4_1.yvrc[((resto_1.ifr << 3) + 1) * 400 - 3600], &
		dato4_1.zvrc[((resto_1.ifr << 3) + 1) * 30 - 270]);
	if (ie == 2) {
	    goto L10000;
	}
	manual3r_(&c__3, &dato4_1.grvr3[resto_1.ifr - 1], &dato4_1.xsvr3[
		resto_1.ifr * 200 - 200], &dato4_1.ysvr3[resto_1.ifr * 200 - 
		200], &dato4_1.zwvr3[resto_1.ifr * 10 - 10], &dato4_1.nvr3[
		resto_1.ifr * 10 - 10], &dato4_1.nzvr3[resto_1.ifr - 1], &vl2,
		 &vl1, &wxmin, &ie);
	if (ie == 2) {
	    goto L10000;
	}
	manual3r_(&c__5, &dato4_1.grvr2[resto_1.ifr - 1], &dato4_1.xsvr2[
		resto_1.ifr * 500 - 500], &dato4_1.ysvr2[resto_1.ifr * 500 - 
		500], &dato4_1.zdvr2[resto_1.ifr * 20 - 20], &dato4_1.nvr2[
		resto_1.ifr * 20 - 20], &dato4_1.nzvr2[resto_1.ifr - 1], &vl2,
		 &resto_1.vre1, &ini2_1.asd[ini2_1.ind * 3 - 1], &ie);
	if (ie == 2) {
	    goto L10000;
	}
	if (ini2_1.asd[ini2_1.ind * 3 - 1] > ini1_1.rwy + ini1_1.swy) {
	    ini2_1.ilim[(ini2_1.ind << 2) - 1] = 2;
	    ini2_1.asd[ini2_1.ind * 3 - 1] = ini1_1.rwy + ini1_1.swy;
	    resto_1.dist = ini1_1.rwy + ini1_1.swy;
	    resto_1.vel = 0.f;
	    ini2_1.v1[ini2_1.ind * 3 - 1] = vrfu_(&wxmin);
	    if (resto_1.ierv == 2) {
		goto L10000;
	    }
	} else {
	...
	ini2_1.tor[ini2_1.ind * 3 - 2] = resto_1.cflc;
	...
	if (ini2_1.v1[ini2_1.ind * 3 - 1] < ini2_1.v1[ini2_1.ind * 3 - 3]) {
		...
		*ierr = 540;
		...
		ini2_1.asd[ini2_1.ind * 3 - 1] = ini2_1.asd[ini2_1.ind * 3 - 
			2];
		ini2_1.ilim[(ini2_1.ind << 2) - 3] = ini2_1.ilim[(ini2_1.ind 
			<< 2) - 1];
		...
		*ierr = 540;
	    ...
	    ini2_1.v1[ini2_1.ind * 3 - 2] = (ini2_1.v1[ini2_1.ind * 3 - 3] + 
		    ini2_1.v1[ini2_1.ind * 3 - 1]) * .5f;
	    corr_(&ie, &c__1, &vl1, &ini2_1.v1[ini2_1.ind * 3 - 2], ini2_1.x, 
		    &dato4_1.pvrc[resto_1.ifr * 15 - 15], &mxvrc, &mzvrc, &
		    dato4_1.grvrc[(resto_1.ifr << 3) - 8], &dato4_1.nzvrc[(
		    resto_1.ifr << 3) - 8], &dato4_1.nvrc[((resto_1.ifr << 3) 
		    + 1) * 30 - 270], &dato4_1.xvrc[((resto_1.ifr << 3) + 1) *
	...
	corr_(&ie, &c__1, &vl1, &r__1, ini2_1.x, &dato3_1.pgrc[resto_1.ifc * 
		15 - 15], &mxgrc, &mzgrc, &dato3_1.grgrc[resto_1.ifc * 10 - 
		10], &dato3_1.nzgrc[resto_1.ifc * 10 - 10], &dato3_1.ngrc[(
		resto_1.ifc * 10 + 1) * 20 - 220], &dato3_1.xgrc[(resto_1.ifc 
		* 10 + 1) * 150 - 1650], &dato3_1.ygrc[(resto_1.ifc * 10 + 1) 
		* 150 - 1650], &dato3_1.zgrc[(resto_1.ifc * 10 + 1) * 20 - 
		220]);
	if (ie == 2) {
	    goto L10000;
	}
	manual3r_(&c__2, &dato3_1.grgr2[resto_1.ifc - 1], &dato3_1.xdgr2[
		resto_1.ifc * 500 - 500], &dato3_1.ydgr2[resto_1.ifc * 500 - 
		500], &dato3_1.zwgr2[resto_1.ifc * 20 - 20], &dato3_1.ngr2[
		resto_1.ifc * 20 - 20], &dato3_1.nzgr2[resto_1.ifc - 1], &
		resto_1.cfl1, &vl1, &wxmin, &ie);
	if (ie == 2) {
	    goto L10000;
	}
	...
	resto_1.dist = ini1_1.rwy - ini1_1.del_rwy__;
	resto_1.vel = 0.f;
	ini2_1.v1[ini2_1.ind * 3 - 3] = vrfu_(&wxmin);
	if (resto_1.ierv == 2) {
	    goto L10000;
	}
	resto_1.cflc = ini1_1.rwy - ini1_1.del_rwy__;
	...
	if (ini1_1.swy == 0.f) {
	    ...
	    ini2_1.v1[ini2_1.ind * 3 - 2] = ini2_1.v1[ini2_1.ind * 3 - 3];
	    ini2_1.v1[ini2_1.ind * 3 - 1] = ini2_1.v1[ini2_1.ind * 3 - 3];
	    ini2_1.asd[ini2_1.ind * 3 - 2] = resto_1.cflc;
	    ini2_1.asd[ini2_1.ind * 3 - 1] = resto_1.cflc;
	    ini2_1.tor[ini2_1.ind * 3 - 2] = resto_1.cflc;
	    ini2_1.tor[ini2_1.ind * 3 - 1] = resto_1.cflc;
	    ini2_1.ilim[(ini2_1.ind << 2) - 2] = ini2_1.ilim[(ini2_1.ind << 2)
		     - 4];
...
L800:
	...
	itemax = 100;
	resto_1.dist = ini1_1.rwy + ini1_1.swy;
	resto_1.vel = ini2_1.vmcg[ini2_1.ind - 1];
	zfalse_((E_fp)vrfu_, &error, &cifsig, &ini1_1.wmin, &wxmin, &vl1, &
		itemax, &ie);
	if (resto_1.ierv == 2) {
	    goto L10000;
	}
	...
	corr_(&ie, &c__0, &vl1, &ini2_1.tor[ini2_1.ind * 3 - 3], ini2_1.x, &
		dato3_1.pgrc[resto_1.ifc * 15 - 15], &mxgrc, &mzgrc, &
		dato3_1.grgrc[resto_1.ifc * 10 - 10], &dato3_1.nzgrc[
		resto_1.ifc * 10 - 10], &dato3_1.ngrc[(resto_1.ifc * 10 + 1) *
		 20 - 220], &dato3_1.xgrc[(resto_1.ifc * 10 + 1) * 150 - 1650]
		, &dato3_1.ygrc[(resto_1.ifc * 10 + 1) * 150 - 1650], &
		dato3_1.zgrc[(resto_1.ifc * 10 + 1) * 20 - 220]);
	if (ie == 2) {
	    goto L10000;
	}
	ini2_1.v1[ini2_1.ind * 3 - 2] = ini2_1.vmcg[ini2_1.ind - 1];
	ini2_1.v1[ini2_1.ind * 3 - 1] = ini2_1.vmcg[ini2_1.ind - 1];
	ini2_1.asd[ini2_1.ind * 3 - 2] = ini1_1.rwy + ini1_1.swy;
	ini2_1.asd[ini2_1.ind * 3 - 1] = ini1_1.rwy + ini1_1.swy;
	ini2_1.tor[ini2_1.ind * 3 - 2] = ini2_1.tor[ini2_1.ind * 3 - 3];
	ini2_1.tor[ini2_1.ind * 3 - 1] = ini2_1.tor[ini2_1.ind * 3 - 3];
    }
    ebrk_(&c__0, &wxmin, &ener, &ini2_1.v1[ini2_1.ind * 3 - 1]);
    if (resto_1.iere == 2) {
	goto L10000;
    }
    if (ener > dagen3_1.limene[0]) {
	ebrk_(&c__0, &wxmin, &ener, &ini2_1.v1[ini2_1.ind * 3 - 3]);
	if (resto_1.iere == 2) {
	    goto L10000;
	}
	if (ener > dagen3_1.limene[0]) {
	    ini2_1.ilim[(ini2_1.ind << 2) - 4] = 8;
	    error = .01f;
	    cifsig = 6;
	    itemax = 100;
	    zfalse_((E_fp)fbrk_, &error, &cifsig, &ini1_1.wmin, &wxmin, &vl1, 
		    &itemax, &ie);
	    if (resto_1.ierb == 2) {
		goto L10000;
	    }
		...
		*ierr = 530;
	    ...
	    ini2_1.grad[dagen3_1.segm[ini2_1.ifl - 1] + ini2_1.ind * 3 - 4] = 
		    -999.f;
	    ini2_1.vr[ini2_1.ind - 1] = 0.f;
	    ini2_1.v1[ini2_1.ind * 3 - 3] = resto_1.vcef;
	    ini2_1.v1[ini2_1.ind * 3 - 2] = resto_1.vcef;
	    ini2_1.v1[ini2_1.ind * 3 - 1] = resto_1.vcef;
	    ini2_1.tor[ini2_1.ind * 3 - 3] = resto_1.cflc;
	    ini2_1.tor[ini2_1.ind * 3 - 2] = resto_1.cflc;
	    ini2_1.tor[ini2_1.ind * 3 - 1] = resto_1.cflc;
	    ini2_1.ilim[(ini2_1.ind << 2) - 3] = 8;
	    ini2_1.ilim[(ini2_1.ind << 2) - 2] = 8;
	    ini2_1.ilim[(ini2_1.ind << 2) - 1] = 8;
	    if (resto_1.vcef > ini2_1.vmcg[ini2_1.ind - 1]) {
		ini2_1.asd[ini2_1.ind * 3 - 3] = resto_1.cflc;
		ini2_1.asd[ini2_1.ind * 3 - 2] = resto_1.cflc;
		ini2_1.asd[ini2_1.ind * 3 - 1] = resto_1.cflc;
	    } else {
		corr_(&ie, &c__1, &vl1, &ini2_1.v1[ini2_1.ind * 3 - 1], 
			ini2_1.x, &dato4_1.pvrc[resto_1.ifr * 15 - 15], &
			mxvrc, &mzvrc, &dato4_1.grvrc[(resto_1.ifr << 3) - 8],
			 &dato4_1.nzvrc[(resto_1.ifr << 3) - 8], &
			dato4_1.nvrc[((resto_1.ifr << 3) + 1) * 30 - 270], &
			dato4_1.xvrc[((resto_1.ifr << 3) + 1) * 400 - 3600], &
			dato4_1.yvrc[((resto_1.ifr << 3) + 1) * 400 - 3600], &
			dato4_1.zvrc[((resto_1.ifr << 3) + 1) * 30 - 270]);
		if (ie == 2) {
		    goto L10000;
		}
		manual3r_(&c__3, &dato4_1.grvr3[resto_1.ifr - 1], &
			dato4_1.xsvr3[resto_1.ifr * 200 - 200], &
			dato4_1.ysvr3[resto_1.ifr * 200 - 200], &
			dato4_1.zwvr3[resto_1.ifr * 10 - 10], &dato4_1.nvr3[
			resto_1.ifr * 10 - 10], &dato4_1.nzvr3[resto_1.ifr - 
			1], &vl2, &vl1, &wxmin, &ie);
		if (ie == 2) {
		    goto L10000;
		}
		manual3r_(&c__5, &dato4_1.grvr2[resto_1.ifr - 1], &
			dato4_1.xsvr2[resto_1.ifr * 500 - 500], &
			dato4_1.ysvr2[resto_1.ifr * 500 - 500], &
			dato4_1.zdvr2[resto_1.ifr * 20 - 20], &dato4_1.nvr2[
			resto_1.ifr * 20 - 20], &dato4_1.nzvr2[resto_1.ifr - 
			1], &vl2, &resto_1.vre1, &ini2_1.asd[ini2_1.ind * 3 - 
			1], &ie);
		if (ie == 2) {
		    goto L10000;
		}
	    ...
	    ebrk_(&c__1, &wxmin, dagen3_1.limene, &ini2_1.v1[ini2_1.ind * 3 - 
		    1]);
	    if (resto_1.iere == 2) {
		goto L10000;
	    }
	    ini2_1.v1[ini2_1.ind * 3 - 2] = (ini2_1.v1[ini2_1.ind * 3 - 3] + 
		    ini2_1.v1[ini2_1.ind * 3 - 1]) * .5f;
	    ini2_1.ilim[(ini2_1.ind << 2) - 1] = 8;
	    corr_(&ie, &c__1, &vl1, &ini2_1.v1[ini2_1.ind * 3 - 1], ini2_1.x, 
		    &dato4_1.pvrc[resto_1.ifr * 15 - 15], &mxvrc, &mzvrc, &
		    dato4_1.grvrc[(resto_1.ifr << 3) - 8], &dato4_1.nzvrc[(
		    resto_1.ifr << 3) - 8], &dato4_1.nvrc[((resto_1.ifr << 3) 
		    + 1) * 30 - 270], &dato4_1.xvrc[((resto_1.ifr << 3) + 1) *
	...
	manual3r_(&c__1, &dato3_1.grda1[resto_1.ifa - 1], &dato3_1.xgda1[
		resto_1.ifa * 200 - 200], &dato3_1.ydda1[resto_1.ifa * 200 - 
		200], &dato3_1.zfda1[resto_1.ifa * 10 - 10], &dato3_1.nda1[
		resto_1.ifa * 10 - 10], &dato3_1.nzda1[resto_1.ifa - 1], &
		ini2_1.grad[dagen3_1.segm[ini2_1.ifl - 1] + ini2_1.ind * 3 - 
		4], &vl1, &r__1, &ie);
	if (ie == 2) {
	    goto L10000;
	}
	corr_(&ie, &c__0, &vl1, &vl2, ini2_1.x, &dato3_1.pda1c[resto_1.ifa * 
		15 - 15], &c__100, &c__15, &dato3_1.grda1c[(resto_1.ifa << 2) 
		- 4], &dato3_1.nzda1c[(resto_1.ifa << 2) - 4], &dato3_1.nda1c[
		((resto_1.ifa << 2) + 1) * 15 - 75], &dato3_1.xda1c[((
		resto_1.ifa << 2) + 1) * 100 - 500], &dato3_1.yda1c[((
		resto_1.ifa << 2) + 1) * 100 - 500], &dato3_1.zda1c[((
		resto_1.ifa << 2) + 1) * 15 - 75]);
	if (ie == 2) {
	    goto L10000;
	}
	resto_1.todc = ini2_1.tor[ini2_1.ind * 3 - 3] + vl2;
    }
    ini2_1.tod[ini2_1.ind * 3 - 3] = resto_1.todc;
    ini2_1.tod[ini2_1.ind * 3 - 2] = resto_1.todc;
    ini2_1.tod[ini2_1.ind * 3 - 1] = resto_1.todc;
L1000:
	...
	if (ini2_1.ind == 2) {
	    for (i__ = 1; i__ <= 4; ++i__) {
		ini2_1.ilim[i__ + (ini2_1.ind << 2) - 5] = resto_1.obs_crit__;
	    }
	    *ierr = 550;
	    return 0;
	}
	...
	cifsig = 6;
	itemax = 100;
	zfalse_((E_fp)difobsm_, &error, &cifsig, &ini1_1.wmin, &wxmin, &vl1, &
		itemax, &ie);
	if (resto_1.ierd > 0) {
	    goto L10000;
	}
	...
	ini2_1.grad[dagen3_1.segm[ini2_1.ifl - 1] + ini2_1.ind * 3 - 4] = 
		resto_1.gradc;
	ini2_1.rc[dagen3_1.segm[ini2_1.ifl - 1] + ini2_1.ind * 3 - 4] = 
		resto_1.rcc;
	...
	fpath_(&c__1, &ini2_1.x[5], &ini2_1.grad[dagen3_1.segm[ini2_1.ifl - 1]
		 + ini2_1.ind * 3 - 4], &c_b83, &dato6_1.xdfp1[ini2_1.ifl * 
...
/* Subroutine */ int milto_lim__(char *vic, char *vid, real *vor, integer *
