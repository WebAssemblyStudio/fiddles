...
// サウンド再���機能( ソフトウエアサウンド、MIDI含む )を無効にする場合は次のコメントを外して下さい
//#define DX_NON_SOUND
...
// 各ハンドルのエラーチェックを無効にする場合は次のコメントを外してください( 若干高速��される代わりに無効なハンドルを関数に渡すと即不正なメモリアクセスエラーが発生するようになります )
...
// 軽量バージョンのＤＸライブラリを生成す��場合は次のコメントを外してください
