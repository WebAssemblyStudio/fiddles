...
extern	int			GetMouseDispFlag(				void ) ;												// マウスポインタを表示するかどうかの設��を取得する( 戻り値  TRUE:表示する  FALSE:表示しない )
...
extern	int			SetWindowRgnGraphWithStrLen( const TCHAR *FileName, size_t FileNameLength ) ;								// 任意の画像ファイルか���ＲＧＮをセットする
