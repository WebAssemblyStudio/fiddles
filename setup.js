...
require.config({
  paths: {
    ...
    "assemblyscript": "https://localhost:28443/assemblyscript/dist/assemblyscript",
    "assemblyscript/bin/asc": "https://localhost:28443/assemblyscript/dist/asc",
...
/*
require(["wabt"], wabt => {
  console.log('setup.js loaded wabt:', wabt);
  logLn('wabts')
});
*/
