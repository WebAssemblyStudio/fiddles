...
// API
WASM_EXPORT void mcu_init(void);
WASM_EXPORT bool mcu_load_ihex(const char *filename);
WASM_EXPORT bool mcu_load_code(const char *code);
WASM_EXPORT void mcu_run(void);
WASM_EXPORT bool mcu_execute_cycle(void);
WASM_EXPORT void mcu_resume(void);
WASM_EXPORT void mcu_get_copy(ATmega328p_t *mcu);
WASM_EXPORT void mcu_send_interrupt(Interrupt_vector_t vector);
WASM_EXPORT void mcu_set_exception_handler(void (*handler)(void));
...
WASM_EXPORT void mcu_get_copy(ATmega328p_t *_mcu) {
  *_mcu = mcu;
