(module
  ...
  (import "gvar" "tbl_len" (global $tbl_len i32))
  (func (export "fft") (param $size i32) (param $dir f32)
    ...
    (set_local $reoff (i32.shl (get_global $tbl_len) (i32.const 1)))
        ...
        (loop $innerloop
          ...
          (set_local $tmp1re (f32.add ;; tpre
            (f32.mul
              ...
              (f32.load (i32.add (get_global $tbl_len) (i32.shl (get_local $tmp3) (i32.const 2))))
            )
            (f32.mul (get_local $dir) (f32.mul
              (f32.load (i32.add (get_local $imoff) (i32.shl (get_local $tmp4) (i32.const 2))))
              (f32.load (i32.add (get_global $tbl_len) (i32.shl (i32.add (get_local $tmp3) (i32.const 1)) (i32.const 2))))
            ))
          ))
