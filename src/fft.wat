(module
  ...
  (import "gvar" "dir" (global $dir f32))
  ...
  (func (export "fft") (param $size i32) (result i32)
    ...
    (local $testoff i32) (set_local $testoff (i32.add (get_local $imoff) (i32.shl (get_local $size) (i32.const 2))))
    (local $testix i32) (set_local $testix (i32.const 0))
    ...
    (set_local $loopcnt (i32.const 1)) ;; size
    (loop $outerloop
      (return (i32.add (get_local $testoff) (i32.shl (get_local $testix) (i32.const 2))))
      (;i32.store (i32.add (get_local $testoff) (i32.shl (get_local $testix) (i32.const 2)));)
      (set_local $testix (i32.add (get_local $testix) (i32.const 1)))
      (set_local $tmp1 (i32.div_u (get_local $size) (get_local $loopcnt))) ;; tablestep ($size := n)
      ...
      (loop $middleloop
        ...
        (loop $innerloop
          ...
          (set_local $tmp1re (f32.add ;; tpre
            ...
            (f32.mul (get_global $dir) (f32.mul
    ...
    (if (f32.eq (get_global $dir) (f32.const -1)) (loop $scaleloop
      ...
      (br_if $scaleloop (i32.eqz (get_local $loopcnt)))
    ))
