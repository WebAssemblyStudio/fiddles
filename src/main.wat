(module
  ...
  (import "eval" "console.log" (func $logf64 (param f64)))
  (import "eval" "performance.now.bind(performance)" (func $performancenow (result f64)))
  ;; data
  ...
  (func $main
    ...
    (set_local $t0 (call $performancenow))
    ...
    (call $logf64 (f64.sub (call $performancenow) (get_local $t0)))
