(module
  ...
  (func $solidcolorred (result i32)
    i32.const 0xFF0000FF
  )

  (func $solidcolorblue (result i32)
  ...
  (func $loopcol (param $y i32)
    ...
    (block 
      (loop
        ...
        (call $setpix (get_local $x) (get_local $y)   (call_indirect (param i32) (param i32) (result i32) (get_local $x) (get_local $y) (i32.const 2)))
