...
function drawFrame(frame) {
  ...
  let offset_x = positions[count % positions.length]; // how far to push logo over
  let offset_y = 0;
  ...
  positions.reverse();
  offset_x = positions[count % positions.length]; // how far to push logo over
  offset_y = frame.height - HEIGHT;
  for (var i = 0; i < IMAGE.length; i++) {
    let y = Math.floor(i / WIDTH);
    let x = i % WIDTH;
