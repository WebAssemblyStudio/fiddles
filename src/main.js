...
fetch(x).then(response =>
  ...
  instance = results.instance; // 获取wasm实例
  document.getElementById("container").textContent = instance.exports.main1();
  document.getElementById("container").textContent += instance.exports.main2(12, 12);
}).catch(console.error);
