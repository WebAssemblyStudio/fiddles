...
console.log("Build module", Object.keys(exports))
return {
  ...exports
};
// return {};
...
const Loader = loader();
console.log("Loader", Object.keys(Loader))
...
Loader.instantiateStreaming(fetch("../out/main.wasm"), {
  ...
  console.log("result", JSON.stringify(Object.keys(result), null, 2));
  console.log("memory", JSON.stringify(Object.keys(result.memory), null, 2));
  console.log("X", JSON.stringify(Object.keys(result.X), null, 2));
  document.getElementById("container").textContent = "Result: " + result.__getString(result.say(result.__allocString("Hello")));
}).catch(console.error);
