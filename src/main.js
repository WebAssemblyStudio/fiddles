              ...
              if(controlScope[x]!="for"||controlScope[x]!="while") {
                if(controlScope[x] == "if") {
                  ...
                  if(controlScope[x] == "for-start") {
                    console.log("a for has been started");
                    console.log(getDifference(stackOutput, forOldStackOutput));
                    stackOutput.replace(getDifference(stackOutput, forOldStackOutput), "");
                    stackOutput += getDifference(stackOutput, forOldStackOutput);
                  }
