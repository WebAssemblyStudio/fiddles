...
fetch(x).then(response =>
  ...
  var {main,CreateVector2,Vector2_get_x,Vector2_get_y,Test} = instance.exports;
  var pos = CreateVector2(2,3)
  document.getElementById("container").textContent = Vector2_get_y(pos);
  Test(pos)
}).catch(console.error);
