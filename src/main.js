...
WebAssembly.instantiateStreaming(fetch("../out/main.wasm"), {
  ...
  const { memory, utoa64hex_lut, utoa64hex_simple, utoa64_general } = result.instance.exports;
  ...
  console.log('utoa64_general:   0x' + toString(memory.buffer, utoa64_general(value, 16)));
