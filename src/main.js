  ...
  for(var cwn = 0; cwn <= words.length-1; cwn++) { // checks and compiles each word
              ...
              if(controlScope[x]!="for"||controlScope[x]!="while") {
                if(controlScope[x] == "if") {
                  ...
                  if(controlScope[x] == "for-start") {
                    console.log("OLD: ");
                    console.log(forOldStackOutput);
                    var newforOldStackOutput = forOldStackOutput.split("(block\n");
                    console.log("NEW: ");
                    console.log(stackOutput);
                    console.log("DIFFERENCE:")
                    console.log(getDifference(stackOutput, newforOldStackOutput[0]));
                  }
     ...
     */
        ...
        if(controlScope[controlScope.length-1] == "for") {
          ...
          } else if (semiForNum == 2) { // for making third thing go at end
