...
fetchAndInstantiateWasm('./aes.wasm')
  .then(m => {
    //fillPlainBuffer(2 ** 5);
    plainBuffer = new Uint8Array(_base64ToArrayBuffer("PwQU35d0ADN8aZAQX+NdK19jvNlmvq9T6ask7J9yMRksNKrQxIMV678UJhvFFqlyXABE48ibn02chW+eCoH99wxjYstXH5gkpVEZmc9oDZg="));
