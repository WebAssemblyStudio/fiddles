...
WebAssembly.instantiateStreaming(fetch("../out/main.wasm"), {
  ...
  bench(testNewASSort100K, 'AS NEW sort 100_000 doubles  ', container);
  // bench(testNewASSort10M, 'AS NEW sort 10_000_000 doubles', container);
  bench(testNewASSort128, 'AS sort 128 doubles',     container);
