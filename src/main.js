...
const view = (buf) => new Uint8Array(instance.exports.memory.buffer, buf.ptr, buf.len)
const wrap = (f) => (ptr1, len1, ptr2, len2) => {
  console.log(ptr1, len1, ptr2, len2)
  f({ptr: ptr1, len: len1}, {ptr: ptr2, len: len2})
  console.log("PL")
}
  ...
  WebAssembly.instantiate(bytes, {
    ...
    basis: {
      ...
      get_arg_length: wrap((a, b) => {
        ...
        console.log(buf[0] + buf[1] * 256)
        const res = argv[buf[0] + buf[1] * 256].length
        dst[0] = res
        dst[1] = res / 256
      }),
    },
