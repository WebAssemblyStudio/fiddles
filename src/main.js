...
.then(results => {
  ...
  instance.exports.init_fourmi();

  // on dessine l'image dans le canvas, à la position (0,0)

  setInterval(() => {
    // a chaque milli-seconde, on fait 50 itérations puis on les affiche
    instance.exports.steps_fourmi(10);
    ctx.putImageData(imageData, 0, 0); // pour refresh l'image a chaque fois
  }, 1);
