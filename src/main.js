...
WebAssembly.instantiateStreaming(fetch("../out/main.wasm"), {
  ...
  console.log('hue2Rgb:   ', unpack(hue2Rgb(Math.ceil(45 * 256 / 360))));
  console.log('hsvToRgbJS:', hsvToRgbJS(45));

  console.log('hue2Rgb:   ', unpack(hue2Rgb(Math.ceil(60 * 256 / 360))));
  console.log('hsvToRgbJS:', hsvToRgbJS(60));

  console.log('hue2Rgb:   ', unpack(hue2Rgb(Math.ceil(180 * 256 / 360))));
  console.log('hsvToRgbJS:', hsvToRgbJS(180));

  console.log('hue2Rgb:   ', unpack(hue2Rgb(Math.ceil(192 * 256 / 360))));
  console.log('hsvToRgbJS:', hsvToRgbJS(192));

  console.log('hue2Rgb:   ', unpack(hue2Rgb(Math.ceil(360 * 256 / 360))));
