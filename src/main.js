...
fetch('../out/main.wasm').then(response => {
  ...
  document.getElementById("container").textContent += `Result of the typescript-WASM computation: ${resultSum}\n`;
  document.getElementById("container").textContent += `Time to typescript-WASM-compute: ${Date.now() - time}ms\n`;
  time = Date.now();
