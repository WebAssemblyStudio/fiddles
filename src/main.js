     ...
     */
      ...
      if(scope == "variable") {
        if(command == "variable-set") { // not a decimal
          command = "input";
          localHeaderOutput.splice(localHeaderOutput.indexOf("(local $"+currentVariable+" "+variables[variables.indexOf(currentWord)+1]+") "), 1);
          headerOutput.push("(param $"+currentVariable+" "+variables[variables.indexOf(currentWord)+1]+") ");
          commandOffset = cwn;
