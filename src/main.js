...
function tabulate(n) {
  ...
  let wasmFibOut = "★ wasm recursion computed ".concat(wasmFibResult, " in ", wasmFibTime, "ms");
  ...
  let wasmMemoOut = "★ wasm memoization computed ".concat(wasmMemoResult, " in ", wasmMemoTime, "ms");
  ...
  let wasmTabulateOut = "★ wasm tabulation computed ".concat(wasmTabulateResult, " in ", wasmTabulateTime, "ms");
  ...
  let jsMemoOut = "★ js memoization computed ".concat(jsMemoResult, " in ", jsMemoTime, "ms");
