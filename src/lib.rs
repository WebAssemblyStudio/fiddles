...
extern {
    ...
    fn getRandomValue(gridSize: i32, squareSize: i32) -> i32;
    fn endGame();
}
...
impl Game {
  ...
  pub fn eat_food(&mut self) {
    self.erase_food();
    let x = getRandomValue(GRID_SIZE, SQUARE_SIZE);
    let y = getRandomValue(GRID_SIZE, SQUARE_SIZE);
