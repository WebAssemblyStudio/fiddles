...
// @lazy const EXP2F_POLY_ORDER = 3;
@lazy export const EXP2F_N = 1 << EXP2F_TABLE_BITS;
@lazy export const EXP2F_N_MASK = EXP2F_N - 1;
@lazy export const exp2f_data_shift = reinterpret<f64>(0x4338000000000000); // 0x1.8p+52
@lazy export const exp2f_data_shift_scaled = exp2f_data_shift / EXP2F_N;
...
// ];
@lazy export const exp2f_data_invln2_scaled = reinterpret<f64>(0x3FF71547652B82FE) * EXP2F_N; // 0x1.71547652b82fep+0
@lazy export const exp2f_data_poly_scaled: f64[] = [
