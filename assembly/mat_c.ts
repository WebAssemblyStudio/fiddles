...
export class mat_c {
  ...
  @inline @operator("*")
  protected __mul(val: mat_c): mat_c {
    return this.transform(val);
  }

  @inline @operator("*=")
  protected __mut_mut(val: mat_c): mat_c {
    return this.transform_mut(val);
  }

  @inline @operator("<=")
  protected __set(val: mat_c): mat_c {
    this.a = val.a;
    this.b = val.b;
    this.c = val.c;
    this.d = val.d;
