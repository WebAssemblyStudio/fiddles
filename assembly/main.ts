...
const arr128  = new Array<f64>(128);
...
export function randomize(): void {
  ...
  for (let i = 0, len = arr128.length; i < len; i++) {
    arr128[i] = Math.random();
  }
}
...
export function testASSort128(): void {
  arr128.sort((a, b) => i32(a > b) - i32(a < b));
}
...
export function testNewASSort128(): void {
  SORT<f64>(arr128.dataStart, arr128.length, (a, b) => i32(a > b) - i32(a < b));
}
