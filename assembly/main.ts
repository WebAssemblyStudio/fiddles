...
function readFromMemory(dataLength: i32): Float64Array {
    const vals = new Float64Array(dataLength);
...
export function mdeterm(dataLength: i32): f64 {
  
    const vals = readFromMemory(dataLength);
    trace("1", 4, vals[0], vals[1], vals[2], vals[3]);
