...
/** these globals were defined above (outside of any function)
...
let hashOutputPtr = changetype<usize>(hashOutputBuf);
  ...
  let result: i32;
  for (let i = 0; i < 40; i++) {
    result = verifyProof(wantHash, key_path, proof_decoded, keccakCtxBuf, hashOutputPtr, hashOutput);
  }
...
function verifyProof(wantHash: Uint64Array, key_path: Array<u8>, proof_decoded: RLPData,
                      keccakCtxBuf: usize, hashOutputPtr: usize, hashOutput: Uint64Array): i32 {
