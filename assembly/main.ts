...
class Pointer {
  ...
  @inline @operator("[]") get(index: i32): u32 {
    return load<u32>(changetype<usize>(this) + (<usize>index * sizeof<u32>()));
  }

  @inline @operator("[]=") set(index: i32, value: u32): void {
    store<u32>(changetype<usize>(this) + (<usize>index * sizeof<u32>()), value);
  }
}
...
@inline function toRGB(x: i32): u32 {
