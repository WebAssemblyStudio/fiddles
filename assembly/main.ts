...
export function mpt_verify(): i32 {
  ...
  */
  ...
  for (let i = 0; i < 40; i++) {
    let result = verifyProof(wantHash, key_path, proof_decoded);
  }
...
// verifyProof in ethereumjs/merkle-patricia-trie returns the account leaf, we do the same here (a Uint8Array)
