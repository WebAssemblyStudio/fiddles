...
declare function setInterval(a, b?);
declare function setTimeout(a, b?);
declare function clearInterval(a?, b?);
...
(function (root, factory) {
  ...
  return (function () {
    ...
    Loki.prototype.serializeDestructured = function(options) {
      ...
      dbcopy = new (Loki as any)(this.filename);
    ...
    LokiPartitioningAdapter.prototype.loadDatabase = function (dbname, callback) {
      var self=this;
      this.dbname = dbname;
      this.dbref = new (Loki as any)(dbname);
    ...
    Resultset.prototype.limit = function (qty) {
      ...
      var rscopy = new (Resultset as any)(this.collection);
    ...
    Resultset.prototype.copy = function () {
      var result = new (Resultset as any)(this.collection);
    ...
    Collection.prototype.chain = function (transform, parameters) {
      var rs = new (Resultset as any)(this);
    ...
    Collection.prototype.eqJoin = function (joinData, leftJoinProp, rightJoinProp, mapFun, dataOptions) {
      ...
      return new (Resultset as any)(this).eqJoin(joinData, leftJoinProp, rightJoinProp, mapFun, dataOptions);
    };
    ...
    function parseBase10(num) {
      return (parseFloat as any)(num, 10);
    }
    ...
    KeyValueStore.prototype = {
      ...
      setSort: function (fun) {
        this.bs = new (BSonSort as any)(fun);
      },
      bs: function () {
        return new (BSonSort as any)(this.sort);
      },
    ...
    (Loki as any).LokiOps = LokiOps;
    (Loki as any).Collection = Collection;
    (Loki as any).KeyValueStore = KeyValueStore;
    (Loki as any).LokiMemoryAdapter = LokiMemoryAdapter;
    (Loki as any).LokiPartitioningAdapter = LokiPartitioningAdapter;
    (Loki as any).LokiLocalStorageAdapter = LokiLocalStorageAdapter;
    (Loki as any).LokiFsAdapter = LokiFsAdapter;
    (Loki as any).persistenceAdapters = {
      fs: LokiFsAdapter,
      localStorage: LokiLocalStorageAdapter
    };
    (Loki as any).aeq = aeqHelper;
    (Loki as any).lt = ltHelper;
    (Loki as any).gt = gtHelper;
    (Loki as any).Comparators = Comparators;
    return Loki;
  }());
