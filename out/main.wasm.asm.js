function asmFunc(global, env, buffer) {
  ...
  if (($2 | 0) >= (1 | 0)) {
   ...
   label$2 : do {
    ...
    if (HEAPU32[($6 + 4 | 0) >> 2] | 0) {
     ...
     $4 = 0;
     label$4 : do {
      putc_js(HEAP8[((HEAPU32[$6 >> 2] | 0) + $4 | 0) >> 0] | 0 | 0);
      $4 = $4 + 1 | 0;
      $5 = HEAPU32[$7 >> 2] | 0;
 ...
 function __lockfile($0) {
  $0 = $0 | 0;
  var $1 = 0, $2 = 0, $3 = 0, wasm2asm_i32$0 = 0, wasm2asm_i32$1 = 0;
  $3 = HEAPU32[27 >> 2] | 0;
 ...
 function __unlockfile($0) {
  $0 = $0 | 0;
  var wasm2asm_i32$0 = 0, wasm2asm_i32$1 = 0;
  __syscall_ret(__syscall0(375 | 0) | 0 | 0) | 0;
  wasm2asm_i32$0 = $0;
  wasm2asm_i32$1 = 0;
  ...
  label$1 : {
   ...
   $0 = $0 + 76 | 0;
   if ((__syscall3(240 | 0, $0 | 0, 129 | 0, 1 | 0) | 0 | 0) != (4294967258 | 0)) break label$1;
 ...
 function __wait($0, $1, $2, $3) {
  $0 = $0 | 0;
  $1 = $1 | 0;
  $2 = $2 | 0;
  $3 = $3 | 0;
  var $4 = 0, $5 = 0, wasm2asm_i32$0 = 0, wasm2asm_i32$1 = 0, wasm2asm_i32$2 = 0;
  label$1 : {
   label$2 : {
    label$3 : {
     label$4 : {
    ...
    $4 = (wasm2asm_i32$0 = 128, wasm2asm_i32$1 = 0, wasm2asm_i32$2 = $3, wasm2asm_i32$2 ? wasm2asm_i32$0 : wasm2asm_i32$1);
    label$11 : do {
     if ((__syscall4(240 | 0, $0 | 0, $4 | 0, $2 | 0, 0 | 0) | 0 | 0) == (4294967258 | 0)) __syscall4(240 | 0, $0 | 0, 0 | 0, $2 | 0, 0 | 0) | 0;
