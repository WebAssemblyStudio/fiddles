/* SLEC.F -- translated by f2c (version 20100827).
...
/* Subroutine */ int lectg_(char *vic, integer *ier, ftnlen vic_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___3 = { 1, 15, 0, "(A6)", 0 };
...
/* Writing concatenation */
    ...
    i__2 = do_fio(&c__1, afm_1.afm_dat__, (ftnlen)6);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = e_rsfe();
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.verd[2], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen2_1.nfcal, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
	...
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen2_1.fcal[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
...
/* Writing concatenation */
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.verd[0], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwin[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwin[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
...
/*     READ (15,*,ERR=1500)LIMXWIN */
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limslp[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limslp[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limv2vs[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limv2vs[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.ndf[0], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
	i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.df[i__ - 1], (ftnlen)
		sizeof(integer));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoatg[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwing[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limene[0], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
	...
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrfip[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 20; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcrp[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 20; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrfi[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 20; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcr[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
	...
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcru[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.grcbr[0], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.ncbr[0], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
	...
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.xcbr[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ncbr[0];
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.ymcbr[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
	i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.segm[i__ - 1], (ftnlen)
		sizeof(integer));
	if (i__2 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pwc[i__ + if__ * 15 
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pfcc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.indg2, (ftnlen)sizeof(
		integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pg2c[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pgc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato1_1.dgrs1[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pdgrs1c[i__ + if__ * 
		    15 - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	}
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato1_1.drcs1[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pdrcs1c[i__ + if__ * 
		    15 - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.igam, (ftnlen)sizeof(
		integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato1_1.pw2c[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	for (if__ = 1; if__ <= i__2; ++if__) {
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato2_1.ptod[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato2_1.pasd[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato2_1.ptor[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dato2_1.masd[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	    }
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dato2_1.mtor[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dato2_1.mtod[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	...
	for (if__ = 1; if__ <= i__2; ++if__) {
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato3_1.pgrc[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato3_1.ptdc[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato3_1.pda1c[i__ + if__ 
			* 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	...
	for (if__ = 1; if__ <= i__2; ++if__) {
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato4_1.pvrc[i__ + if__ *
			 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato5_1.pvroc[i__ + if__ * 
		    15 - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato5_1.pv2c[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato5_1.dfret[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato5_1.dvrf1[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato5_1.dvrf2[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = do_lio(&c__4, &c__1, (char *)&dato5_1.dvfto[if__ - 1], (ftnlen)
		sizeof(real));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = do_lio(&c__3, &c__1, (char *)&dato6_1.nsen[if__ - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dato6_1.pacc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	if (dato6_1.nsen[if__ - 1] > 1) {
	    ...
	    for (i__ = 1; i__ <= 15; ++i__) {
		i__3 = do_lio(&c__3, &c__1, (char *)&dato6_1.pacac[i__ + if__ 
			* 15 - 16], (ftnlen)sizeof(integer));
		if (i__3 != 0) {
		    goto L1500;
		}
...
/* Writing concatenation */
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.verd[1], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwin[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwin[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limslp[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limslp[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[2], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[3], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.ndf[1], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoatg[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limwing[1], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    for (i__ = 1; i__ <= 20; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcrp[i__ + 19], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 20; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcr[i__ + 19], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 10; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.vrcru[i__ + 9], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.grcbr[1], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.ncbr[1], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.xcbr[i__ + 9], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ncbr[1];
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.ydcbr[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.ndff, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.dff[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdff[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.apdff[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.gadff[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.segdff[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__3 = dagen3_1.ndff;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.madff[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limlg, (ftnlen)sizeof(real))
	    ;
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limty, (ftnlen)sizeof(real))
	    ;
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___100);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 2; i__ <= 3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limene[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
	i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.limdfk[i__ - 1], (
    ...
    i__2 = s_rsle(&io___102);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.iopk, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
	...
	i__3 = s_rsle(&io___106);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald1_1.pwc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = s_rsle(&io___108);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dald1_1.indga[if__ - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___109);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald1_1.pgac[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = s_rsle(&io___110);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dald1_1.indbl[if__ - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___111);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald1_1.pblc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
    ...
    i__2 = dagen3_1.ndf[1];
    for (if__ = 1; if__ <= i__2; ++if__) {
	i__3 = s_rsle(&io___112);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dald2_1.indgr[if__ - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___113);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald2_1.pgrc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = s_rsle(&io___114);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dald2_1.indld[if__ - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___115);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald2_1.pldc[i__ + if__ * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = s_rsle(&io___116);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald3_1.pvr1c[i__ + if__ * 
		    15 - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	i__3 = s_rsle(&io___117);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dald3_1.pvg1c[i__ + if__ * 
		    15 - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dald3_1.dvapp, (ftnlen)sizeof(real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = e_rsle();
    ...
    i__2 = s_rsle(&io___119);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dald3_1.dvman, (ftnlen)sizeof(real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = e_rsle();
...
/* Writing concatenation */
    ...
    i__2 = s_rsle(&io___122);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dagen3_1.verd[3], (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___123);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[4], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limalt[5], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[4], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoat[5], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___125);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[4], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limoati[5], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___126);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[4], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limdi[5], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[4], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__4, &c__1, (char *)&dagen3_1.limw[5], (ftnlen)sizeof(
	    real));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___129);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams1_1.sley, (ftnlen)sizeof(integer)
	    );
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = dams1_1.sley;
    for (il = 1; il <= i__2; ++il) {
	i__3 = s_rsle(&io___131);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams1_1.scod[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___132);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams1_1.sinop[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___133);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams1_1.nsisa[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	if (dams1_1.scod[il - 1] == 0) {
	    i__3 = s_rsle(&io___134);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    i__4 = dams1_1.nsisa[il - 1];
	    for (i__ = 1; i__ <= i__4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams1_1.sisa[i__ + il * 
	    ...
	    cont = 0;
	    for (j = 1; j <= 5; ++j) {
		i__3 = s_rsle(&io___144);
		if (i__3 != 0) {
		    goto L1500;
		}
		for (i__ = 1; i__ <= 5; ++i__) {
		    i__3 = do_lio(&c__4, &c__1, (char *)&dams2_1.spc[j + (i__ 
			    + il * 5) * 5 - 31], (ftnlen)sizeof(real));
		    if (i__3 != 0) {
			goto L1500;
		    }
		}
...
L140:
	    ...
	    i__3 = s_rsle(&io___146);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    i__4 = dams1_1.nsisa[il - 1];
	    for (i__ = 1; i__ <= i__4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams1_1.ysfu[i__ + il * 
			4000 - 4001], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	    }
	    ...
	    i__3 = s_rsle(&io___147);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    i__4 = dams1_1.nsisa[il - 1];
	    for (i__ = 1; i__ <= i__4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams1_1.ysti[i__ + il * 
			4000 - 4001], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	    ...
	    i__3 = s_rsle(&io___148);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    i__4 = dams1_1.nsisa[il - 1];
	    for (i__ = 1; i__ <= i__4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams1_1.ysdi[i__ + il * 
			4000 - 4001], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
...
L50:
	i__3 = s_rsle(&io___149);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams2_1.indtqs[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dams2_1.ntbtqs, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___152);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams3_1.indrc, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___153);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 1; i__ <= 15; ++i__) {
	i__2 = do_lio(&c__3, &c__1, (char *)&dams3_1.prcmc[i__ - 1], (ftnlen)
		sizeof(integer));
	if (i__2 != 0) {
	    goto L1500;
	}
...
L150:
    i__2 = s_rsle(&io___154);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams3_1.nrc, (ftnlen)sizeof(integer))
	    ;
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___155);
    if (i__2 != 0) {
	goto L1500;
    }
    i__3 = dams3_1.nrc;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams3_1.rccln[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___157);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dams3_1.pclnc[i__ + ir * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
...
L160:
    ...
    i__2 = s_rsle(&io___158);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams4_1.indrcf, (ftnlen)sizeof(
	    integer));
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    for (i__ = 1; i__ <= 15; ++i__) {
	i__2 = do_lio(&c__3, &c__1, (char *)&dams4_1.prcmfc[i__ - 1], (ftnlen)
		sizeof(integer));
	if (i__2 != 0) {
	    goto L1500;
	}
...
L151:
    i__2 = s_rsle(&io___160);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams4_1.nrcf, (ftnlen)sizeof(integer)
	    );
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = s_rsle(&io___161);
    if (i__2 != 0) {
	goto L1500;
    }
    i__3 = dams4_1.nrcf;
    for (i__ = 1; i__ <= i__3; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams4_1.rcclnf[i__ - 1], (ftnlen)
		sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___162);
	if (i__3 != 0) {
	    goto L1500;
	}
	for (i__ = 1; i__ <= 15; ++i__) {
	    i__3 = do_lio(&c__3, &c__1, (char *)&dams4_1.pclnfc[i__ + ir * 15 
		    - 16], (ftnlen)sizeof(integer));
	    if (i__3 != 0) {
		goto L1500;
	    }
...
L161:
    ...
    i__2 = do_lio(&c__3, &c__1, (char *)&dams5_1.cley, (ftnlen)sizeof(integer)
	    );
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = dams5_1.cley;
    for (il = 1; il <= i__2; ++il) {
	i__3 = s_rsle(&io___164);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams5_1.cinop[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___165);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams5_1.ncisa[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___166);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__4 = dams5_1.ncisa[il - 1];
	for (i__ = 1; i__ <= i__4; ++i__) {
	    i__3 = do_lio(&c__4, &c__1, (char *)&dams5_1.cisa[i__ + il * 9 - 
	...
	cont = 0;
	for (j = 1; j <= 5; ++j) {
	    i__3 = s_rsle(&io___167);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    for (i__ = 1; i__ <= 4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams6_1.cpc[j + (i__ + (
			il << 2)) * 5 - 26], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
	    }
...
L170:
    ...
    i__2 = s_rsle(&io___168);
    if (i__2 != 0) {
	goto L1500;
    }
    i__2 = do_lio(&c__3, &c__1, (char *)&dams7_1.dley, (ftnlen)sizeof(integer)
	    );
    if (i__2 != 0) {
	goto L1500;
    }
    ...
    i__2 = dams7_1.dley;
    for (il = 1; il <= i__2; ++il) {
	i__3 = s_rsle(&io___169);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams7_1.dinop[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___170);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__3 = do_lio(&c__3, &c__1, (char *)&dams7_1.ndisa[il - 1], (ftnlen)
		sizeof(integer));
	if (i__3 != 0) {
	    goto L1500;
	}
	...
	i__3 = s_rsle(&io___171);
	if (i__3 != 0) {
	    goto L1500;
	}
	i__4 = dams7_1.ndisa[il - 1];
	for (i__ = 1; i__ <= i__4; ++i__) {
	    i__3 = do_lio(&c__4, &c__1, (char *)&dams7_1.disa[i__ + il * 9 - 
		    10], (ftnlen)sizeof(real));
	    if (i__3 != 0) {
		goto L1500;
	    }
	...
	cont = 0;
	for (j = 1; j <= 5; ++j) {
	    i__3 = s_rsle(&io___172);
	    if (i__3 != 0) {
		goto L1500;
	    }
	    for (i__ = 1; i__ <= 4; ++i__) {
		i__3 = do_lio(&c__4, &c__1, (char *)&dams7_1.dpc[j + (i__ + (
			il << 2)) * 5 - 26], (ftnlen)sizeof(real));
		if (i__3 != 0) {
		    goto L1500;
		}
...
L180:
    ...
    for (i__ = 1; i__ <= 5; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams8_1.fuel_f__[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = s_rsle(&io___174);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 1; i__ <= 5; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams8_1.time_0__[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = s_rsle(&io___175);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 1; i__ <= 5; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams8_1.time_h__[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = s_rsle(&io___176);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 1; i__ <= 5; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams8_1.dist_0__[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
    ...
    i__2 = s_rsle(&io___177);
    if (i__2 != 0) {
	goto L1500;
    }
    for (i__ = 1; i__ <= 5; ++i__) {
	i__2 = do_lio(&c__4, &c__1, (char *)&dams8_1.dist_h__[i__ - 1], (
		ftnlen)sizeof(real));
	if (i__2 != 0) {
	    goto L1500;
	}
	...
	integer *npcur, real *xpu, real *ypu, integer *ier)
{
    ...
    *ier = 0;
    io___178.ciunit = *uni;
    i__1 = s_rsle(&io___178);
    if (i__1 != 0) {
	goto L1500;
    }
    i__1 = do_lio(&c__3, &c__1, (char *)&(*grint), (ftnlen)sizeof(integer));
    if (i__1 != 0) {
	goto L1500;
    }
    i__1 = e_rsle();
    ...
    i__1 = do_lio(&c__3, &c__1, (char *)&(*npcur), (ftnlen)sizeof(integer));
    if (i__1 != 0) {
	goto L1500;
    }
    i__1 = e_rsle();
	...
	*ier = 1;
    ...
    io___180.ciunit = *uni;
    i__1 = s_rsle(&io___180);
    if (i__1 != 0) {
	goto L1500;
    }
    i__2 = *npcur;
    for (i__ = 1; i__ <= i__2; ++i__) {
	i__1 = do_lio(&c__4, &c__1, (char *)&xpu[i__], (ftnlen)sizeof(real));
	if (i__1 != 0) {
	    goto L1500;
	}
    }
    ...
    i__2 = *npcur;
    for (i__ = 1; i__ <= i__2; ++i__) {
	i__1 = do_lio(&c__4, &c__1, (char *)&ypu[i__], (ftnlen)sizeof(real));
	if (i__1 != 0) {
	    goto L1500;
	}
    }
	...
	real *xpu, real *ypu, integer *ier)
{
    ...
    *ier = 0;
    ...
    i__1 = do_lio(&c__3, &c__1, (char *)&(*nz), (ftnlen)sizeof(integer));
    if (i__1 != 0) {
	goto L1500;
    }
    i__1 = e_rsle();
	...
	*ier = 1;
    ...
    i__2 = *nz;
    for (i__ = 1; i__ <= i__2; ++i__) {
	i__1 = do_lio(&c__4, &c__1, (char *)&zcur[i__], (ftnlen)sizeof(real));
	if (i__1 != 0) {
	    goto L1500;
	}
    }
    ...
    i__2 = *nz;
    for (i__ = 1; i__ <= i__2; ++i__) {
	i__1 = do_lio(&c__3, &c__1, (char *)&npcur[i__], (ftnlen)sizeof(
		integer));
	if (i__1 != 0) {
	    goto L1500;
	}
